...
该插件是[Difegue / LANraragi](https://github.com/Difegue/LANraragi)项目的元数据插件，适配最新官方Docker镜像。

由于[uparrows/LANraragi_cn](https://github.com/uparrows/LANraragi_cn)项目与[WindyCloudCute/LANraragi_Chinese](https://github.com/WindyCloudCute/LANraragi_Chinese)项目没有继续更新（<span style="font-color:red">P.S. 官方最新版已支持中文</span>）遂没有在针对以上进行测试。
...
3. 配置好前置登录插件`E-Hentai`
    ![E-Hentai_login](./img/E-Hentai_login.png)
